...
const TaskForm = ({ onClose }) => {
  ...
  <div
    className={`bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md transform transition-all duration-300 border border-blue-500 shadow-lg dark:shadow-blue-500 ${
